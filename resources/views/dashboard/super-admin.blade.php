...
<div class="row row-sm">
    <div class="col-sm-12 col-lg-12 col-xl-9">
       ...
       <div class="row">
    <div class="col-12">
        <div class="card custom-card bg-primary border-0 overflow-hidden shadow-sm">
            <div class="">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-9 col-md-8 col-12">
                        ...
                        <p class="text-white-50 mb-0">
                            You have managed
                            <span class="fw-semibold text-white">{{ $totalSchools }}</span>
                            schools and
                            <span class="fw-semibold text-white">{{ $totalVendors }}</span>
                            vendors today. The system is operating at
                            <span class="text-warning fw-bold">100% efficiency</span>.
                        </p>
                    ...
                    <div class="card-body">
                        <div class="card-item">
                            <div class="card-item-title mb-2">
                                <label class="main-content-label fs-13 fw-bold mb-1 text-uppercase">Total
                                    Schools</label>
                            ...
                            <div class="card-item-body">
                                <div class="card-item-stat">
                                    ...
                                    <small class="text-success"><b
                                            class="me-1">{{ $approvedVendors }}</b>Approved</small>
                                </div>
            ...
            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                <div class="card custom-card">
                    <div class="card-body">
                        <div class="card-item">
                            <div class="card-item-title mb-2">
                                <label class="main-content-label fs-13 fw-bold mb-1 text-uppercase">System
                                    Classes</label>
    ...
    <div class="col-sm-12 col-lg-12 col-xl-3">
        ...
        <div class="card custom-card overflow-hidden">
            <div class="card-body text-center">
                <div class="mb-3">
                    <img src="{{ asset('assets/media-79.svg') }}" alt="launch" class="img-fluid"
                        style="height: 100px;">
                </div>
