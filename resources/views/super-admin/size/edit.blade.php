                ...
                <form action="{{ route('size.update', $size->size_id) }}" method="POST">
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="size_name" value="{{ old('size_name', $size->size_name) }}" 
                                   class="form-control @error('size_name') is-invalid @enderror" 
                                   placeholder="e.g. XL, 32, LARGE" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="display_name" value="{{ old('display_name', $size->display_name) }}" 
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="sort_order" value="{{ old('sort_order', $size->sort_order) }}" 
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="is_active" class="form-select" required>
                                <option value="1" {{ old('is_active', $size->is_active) == '1' ? 'selected' : '' }}>Active</option>
                                <option value="0" {{ old('is_active', $size->is_active) == '0' ? 'selected' : '' }}>Inactive</option>
                            </select>
                        </div>

                        <div class="col-md-12 mt-5">
                            <button type="submit" class="btn btn-primary w-100 py-3 fw-bold rounded-3 shadow-sm">
                                <i class="ti ti-check me-1"></i> Update Size
                            </button>
                        </div>
                    </div>
                </form>
