                    ...
                    <div class="card-header bg-white py-3 border-bottom">
                        <div class="d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 fw-bold">
                                <i class="ti ti-edit text-primary me-2"></i> Edit Role: <span class="text-primary">{{ ucfirst($role->name) }}</span>
                            </h4>
                            ...
                            <div class="p-4 border-bottom bg-light-subtle">
                                <div class="row align-items-center">
                                    <div class="col-md-7">
                                        ...
                                        <input type="text" name="name" class="form-control form-control-lg border-2" value="{{ old('name', $role->name) }}" placeholder="Enter role name (e.g. Sales Manager)" required>
                                        <div class="form-text mt-1 small">Update the unique identifier for this role.</div>
                                    </div>
                            ...
                            <div class="card-footer bg-white border-top p-4">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="text-muted small">
                                        <i class="ti ti-info-circle me-1"></i> Permissions update will affect all users assigned this role.
                                    </div>
