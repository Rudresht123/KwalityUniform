    ...
    <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data" id="product-form">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                ...
                <p class="text-muted fs-13">Fill in the details below to create a new product and its variants.</p>
            </div>
            <div class="btn-list">
        ...
        <div class="row">
                    ...
                    <div class="card-body px-4 pb-4">
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="fabric_composition" value="{{ old('fabric_composition') }}" 
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="gender_type" class="form-select form-select-sm @error('gender_type') is-invalid @enderror" required>
                                    ...
                                    <option value="boys" {{ old('gender_type') == 'boys' ? 'selected' : '' }}>Boys</option>
                                    <option value="girls" {{ old('gender_type') == 'girls' ? 'selected' : '' }}>Girls</option>
                                </select>
            ...
            <div class="col-xl-4">
                ...
                <div class="card form-section-card">
                    ...
                    <div class="card-body px-4 pb-4">
                        <p class="text-muted fs-12 mb-3">Upload multiple high-quality images. The first image will be set as primary.</p>
                                                ...
                                                <td>
                                                    <select name="variants[{{ $index }}][size_id]" class="form-select form-select-sm">
                                                        ...
                                                        @foreach($sizes as $size)
                                                            <option value="{{ $size->size_id }}" {{ $variant['size_id'] == $size->size_id ? 'selected' : '' }}>{{ $size->size_name }}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                                <td>
                                                    <select name="variants[{{ $index }}][color_id]" class="form-select form-select-sm">
                                                        ...
                                                        @foreach($colors as $color)
                                                            <option value="{{ $color->color_id }}" {{ $variant['color_id'] == $color->color_id ? 'selected' : '' }}>{{ $color->color_name }}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
