    ...
    <div class="col-lg-8">
        <div class="card custom-card">
            <div class="card-header justify-content-between">
                <div class="card-title">Create New Color</div>
                    ...
                    <div class="row g-4">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="color_name" value="{{ old('color_name') }}" 
                                   ...
                                   placeholder="e.g. Royal Blue, Crimson Red" required autofocus>
                            @error('color_name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>

                        <div class="col-md-6">
                            <label class="form-label fw-bold">Hex Code</label>
                            <input type="text" name="hex_code" value="{{ old('hex_code', '#000000') }}" 
                        ...
                        <div class="col-md-12 mt-5">
                            <button type="submit" class="btn btn-primary w-100 py-3 fw-bold rounded-3 shadow-sm">
                                <i class="ti ti-check me-1"></i> Save Color
                            </button>
                        </div>
                    </div>
                </form>
